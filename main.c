...
uint8 usDriver_Seat_Desired_Temp = SEAT_HEATING_OFF;
uint8 usPassenger_Seat_Desired_Temp= SEAT_HEATING_OFF;

/* Define current temperature variables for driver and passenger seats */
uint16 usDriverSeatCurrentTemp;
uint16 usPassengerSeatCurrentTemp;

/* Define a structure to record failures */
FailureRecord latestFailure[2];

/* Define initial heating levels for driver and passenger */
HeatingLevel ucDriverHeaterIntensity = TURN_OFF_HEATER;
HeatingLevel ucPassengerHeaterIntensity = TURN_OFF_HEATER;
...
{
 /* Driver Task ID*/ DRIVER_TASK_ID,
 /* Driver Seat Button */  SW1_BUTTON_PIN_NUM_INDEX,
 /* Driver Seat Button Presses Count */ 0,
 /* Driver Seat Heating Temp*/ SEAT_HEATING_OFF
};

/* Structure to hold passenger seat task information */
TaskInformation PassengerSeatTask =
{
 /* Passenger Task ID*/ PASSENGER_TASK_ID,
 /* Passenger Seat Button */  SW2_BUTTON_PIN_NUM_INDEX,
 /* Passenger Seat Button Presses Count*/ 0,
 /* Passenger Seat Heating Temp*/ SEAT_HEATING_OFF
};
/* Function prototypes */
